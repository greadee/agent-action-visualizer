...
- NSIS is not installed on the validation host. Installer construction is a
  Windows CI gate, but install, launch, uninstall, and reinstall were not
  directly exercised locally.
